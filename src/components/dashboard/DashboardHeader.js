                    ...
                    <div className="content">
                      <ul>
                        <li>
                          <a href="#" className="clearfix">
                            <figure className="image">
                              <img src="assets/admin/images/!sample-user.jpg" alt="Joseph Doe Junior" className="img-circle" />
                            </figure>
                        ...
                        <li>
                          <a href="#" className="clearfix">
                            <figure className="image">
                              <img src="assets/admin/images/!sample-user.jpg" alt="Joseph Junior" className="img-circle" />
                            </figure>
                        ...
                        <li>
                          <a href="#" className="clearfix">
                            <figure className="image">
                              <img src="assets/admin/images/!sample-user.jpg" alt="Joe Junior" className="img-circle" />
                            </figure>
              ...
              <div id="userbox" className="userbox">
                <a href="#" data-toggle="dropdown">
                  <figure className="profile-picture">
                    <img src="assets/admin/images/!logged-user.jpg" alt="Joseph Doe" className="img-circle" data-lock-picture="assets/admin/images/!logged-user.jpg" />
                  </figure>
                ...
                <div className="dropdown-menu">
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <a role="menuitem" tabIndex={-1} href="pages-user-profile.html"><i className="fa fa-user" /> My Profile</a>
                    </li>
                    <li>
                      <a role="menuitem" tabIndex={-1} href="#" data-lock-screen="true"><i className="fa fa-lock" /> Lock Screen</a>
                    </li>
                    <li>
                      <a role="menuitem" tabIndex={-1} href="pages-signin.html"><i className="fa fa-power-off" /> Logout</a>
                    </li>
                  </ul>
                </div>
              </div>
                        ...
                        <div className="col-lg-8">
                          <div className="chart-data-selector" id="salesSelectorWrapper">
                            ...
                            <div id="salesSelectorItems" className="chart-data-selector-items mt-sm">
                              ...
                              <div className="chart chart-sm" data-sales-rel="Porto Admin" id="flotDashSales1" />
                              {/* Flot: Sales Porto Drupal */}
                              <div className="chart chart-sm" data-sales-rel="Porto Drupal" id="flotDashSales2" />
                              {/* Flot: Sales Porto Wordpress */}
                              <div className="chart chart-sm" data-sales-rel="Porto Wordpress" id="flotDashSales3" />
                            </div>
                          </div>
                        </div>
                  ...
                  <section className="panel">
                    <header className="panel-heading">
                      <div className="panel-actions">
                        <a href="#" className="panel-action panel-action-toggle" data-panel-toggle />
                        <a href="#" className="panel-action panel-action-dismiss" data-panel-dismiss />
                      </div>
                      <h2 className="panel-title">Best Seller</h2>
                      <p className="panel-subtitle">Customize the graphs as much as you want, there are so many options and features to display information using Porto Admin Template.</p>
                    </header>
                    <div className="panel-body">
                      {/* Flot: Basic */}
                ...
                <div className="col-md-6">
                  <section className="panel">
                    <header className="panel-heading">
                      ...
                      <p className="panel-subtitle">It's easy to create custom graphs on Porto Admin Template, there are several graph types that you can use, such as lines, bars, pie charts, etc...</p>
                    </header>
                    <div className="panel-body">
                      {/* Flot: Curves */}
                        ...
                        <header className="panel-heading bg-primary">
                          <div className="widget-profile-info">
                            ...
                            <div className="profile-info">
                              <h4 className="name text-weight-semibold">John Doe</h4>
                                ...
                                <ul className="widget-todo-list">
                                  <li>
                                    <div className="checkbox-custom checkbox-default">
                                      <input type="checkbox" defaultChecked id="todoListItem1" className="todo-check" />
                                      <label className="todo-label" htmlFor="todoListItem1"><span>Lorem ipsum dolor sit amet</span></label>
                                    </div>
                                  ...
                                  <li>
                                    <div className="checkbox-custom checkbox-default">
                                      ...
                                      <label className="todo-label" htmlFor="todoListItem2"><span>Lorem ipsum dolor sit amet</span></label>
                                    </div>
                                    <div className="todo-actions">
                                      <a className="todo-remove" href="#">
                                        <i className="fa fa-times" />
                                  ...
                                  <li>
                                    <div className="checkbox-custom checkbox-default">
                                      ...
                                      <label className="todo-label" htmlFor="todoListItem3"><span>Lorem ipsum dolor sit amet</span></label>
                                    </div>
                                    <div className="todo-actions">
                                      <a className="todo-remove" href="#">
                                        <i className="fa fa-times" />
                                  ...
                                  <li>
                                    <div className="checkbox-custom checkbox-default">
                                      ...
                                      <label className="todo-label" htmlFor="todoListItem4"><span>Lorem ipsum dolor sit amet</span></label>
                                    </div>
                                    <div className="todo-actions">
                                      <a className="todo-remove" href="#">
                                        <i className="fa fa-times" />
                                  ...
                                  <li>
                                    <div className="checkbox-custom checkbox-default">
                                      ...
                                      <label className="todo-label" htmlFor="todoListItem5"><span>Lorem ipsum dolor sit amet</span></label>
                                    </div>
                                    <div className="todo-actions">
                                      <a className="todo-remove" href="#">
                                        <i className="fa fa-times" />
                                  ...
                                  <li>
                                    <div className="checkbox-custom checkbox-default">
                                      ...
                                      <label className="todo-label" htmlFor="todoListItem6"><span>Lorem ipsum dolor sit amet</span></label>
                                    </div>
                                    <div className="todo-actions">
                                      <a className="todo-remove" href="#">
                                        <i className="fa fa-times" />
                ...
                <div className="col-xl-3 col-lg-6">
                  <section className="panel panel-transparent">
                    ...
                    <div className="panel-body">
                      <section className="panel">
                        <div className="panel-body">
                          <div className="small-chart pull-right" id="sparklineBarDash" />
                          <div className="h4 text-weight-bold mb-none">488</div>
                      ...
                      <section className="panel">
                        <div className="panel-body">
                          ...
                          <div className="h4 text-weight-bold mb-none">12</div>
                          <p className="text-xs text-muted mb-none">Working Projects</p>
                        </div>
                      </section>
                      <section className="panel">
                        <div className="panel-body">
                          <div className="small-chart pull-right" id="sparklineLineDash" />
                          <div className="h4 text-weight-bold mb-none">89</div>
                  ...
                  <section className="panel">
                    <header className="panel-heading">
                      ...
                      <h2 className="panel-title">
                        <span className="label label-primary label-sm text-weight-normal va-middle mr-sm">198</span>
                    ...
                    <div className="panel-footer">
                      <div className="input-group input-search">
                        <input type="text" className="form-control" name="q" id="q" placeholder="Search..." />
                        <span className="input-group-btn">
                        <button className="btn btn-default" type="submit"><i className="fa fa-search" />
                        </button>
                      </span>
                      </div>
                    </div>
                            ...
                            <li>
                              <div className="tm-box">
                                ...
                                <div className="thumbnail-gallery">
                                  <a className="img-thumbnail lightbox" href="assets/admin/images/projects/project-4.jpg" data-plugin-options="{ &quot;type&quot;:&quot;image&quot; }">
                                    <img className="img-responsive" width={215} src="assets/admin/images/projects/project-4.jpg" />
                                    <span className="zoom">
                  ...
                  <div className="sidebar-widget widget-friends">
                    ...
                    <ul>
                      <li className="status-online">
                        <figure className="profile-picture">
                          <img src="assets/admin/images/!sample-user.jpg" alt="Joseph Doe" className="img-circle" />
                        </figure>
                        <div className="profile-info">
